{if 'mainmenu' == $position}
	{ia_menu menus=$menu.contents class="nav navbar-nav nav-mainmenu {$menu.classname}"}
{elseif 'inventory' == $position}
	{ia_menu menus=$menu.contents class="nav navbar-nav nav-inventory {$menu.classname}"}
...
{elseif 'copyright' == $position}
	{ia_menu menus=$menu.contents class="nav nav-inline pull-right {$menu.classname}"}
{else}
	<!--__ms_{$menu.id}-->
